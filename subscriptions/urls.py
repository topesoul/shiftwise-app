...
from .views import (CancelSubscriptionView, DowngradeSubscriptionView,
                    ManageSubscriptionView, StripeWebhookView, SubscribeView,
                    SubscriptionHomeView, UpdatePaymentMethodView,
                    UpgradeSubscriptionView, subscription_cancel,
