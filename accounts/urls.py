...
urlpatterns = [
    ...
    path('signup/invitation/<str:token>/', views.AcceptInvitationView.as_view(), name='accept_invitation'),

    # Dashboard URLs
    path('dashboard/superuser/', views.SuperuserDashboardView.as_view(), name='superuser_dashboard'),
    path('dashboard/agency/', views.AgencyDashboardView.as_view(), name='agency_dashboard'),
