...
# ----------------------------
from .views import (AcceptInvitationView, ActivateTOTPView, AgencyCreateView,
                    AgencyDashboardView, AgencyDeleteView, AgencyListView,
                    AgencySignUpView, AgencyUpdateView, CustomLoginView,
                    DisableTOTPView, InviteStaffView, LogoutView,
                    MFAVerifyView, ProfileView, ResendTOTPCodeView,
                    SignupSelectionView, SignUpView, StaffDashboardView,
                    SuperuserDashboardView, UserCreateView, UserDeleteView,
                    UserListView, UserUpdateView, get_address)
...
urlpatterns = [
    ...
    path(
        "manage/agencies/<int:pk>/update/",
        AgencyUpdateView.as_view(),
        name="update_agency",
    ),
    path(
        "manage/agencies/<int:pk>/delete/",
